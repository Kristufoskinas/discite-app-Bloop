              ...
              children: <Widget>[
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (bloop_title.length < 1) {
                      showDialog(
                          context: context,
                          builder: (context) => CupertinoAlertDialog(
                                title: const Text("Error!"),
                                content: const Text(
                                    "You should try adding a title!"),
                                actions: [
                                  TextButton(
                                      onPressed: () {
                                        Navigator.pop(context);
                    ...
                    } else if (_title.text.length < 1) {
                      showDialog(
                          context: context,
                          builder: (context) => CupertinoAlertDialog(
                                title: const Text("Error!"),
                                content: const Text(
                                    "You should try adding some text!"),
                                actions: [
                                  TextButton(
                                      onPressed: () {
                                        Navigator.pop(context);
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Padding(
                            padding:
                                const EdgeInsets.fromLTRB(5.0, 1.0, 15.0, 0.0),
                            child: SizedBox(
                              child: Image.asset(
