...
class SummaryDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<Summarize> _futureSummary;
    ...
    _summarizeText() async {
      ...
      Summarize summarizedText =
          await Summarize().summarizeText2(_textCont.text);
      showDialog(
          context: context,
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: SingleChildScrollView(
                child: Text(_futureSummary != null ? '$_futureSummary' : "..."),
              ),
              actions: [
                TextButton(
                    onPressed: () => {
                          _textCont.text =
                              _futureSummary != null ? _futureSummary : "...",
